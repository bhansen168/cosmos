...
def play_game(
    ...
    outcome = play_engine_game(players[black_index], players[white_index], rng,save = save)
...
def run_match(
    ...
    for game_index in range(games):
        ...
        stats.record(play_game(players, colors, rng,save=save))
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    try:
        SAV = bool(int(input("Type 1 to save, or 0 to not: ")))
